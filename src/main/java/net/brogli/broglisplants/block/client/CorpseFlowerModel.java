...
public class CorpseFlowerModel extends AnimatedGeoModel<EntityCorpseFlower> {
    ...
    @Override
    public ResourceLocation getModelLocation(EntityCorpseFlower object) {
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityCorpseFlower object) {
        return new ResourceLocation(BroglisPlants.MOD_ID, "textures/block/entity_corpse_flower.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityCorpseFlower animatable) {
