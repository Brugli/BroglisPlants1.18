...
public class FlytrapModel extends AnimatedGeoModel<EntityFlytrap> {
    ...
    @Override
    public ResourceLocation getModelLocation(EntityFlytrap object) {
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityFlytrap object) {
        return new ResourceLocation(BroglisPlants.MOD_ID, "textures/block/entity_flytrap.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityFlytrap animatable) {
