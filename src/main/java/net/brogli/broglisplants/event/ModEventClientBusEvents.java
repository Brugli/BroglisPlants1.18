...
public class ModEventClientBusEvents {
    ...
    public static void clientSetup(final FMLClientSetupEvent event) {
        ItemBlockRenderTypes.setRenderLayer(BroglisPlantsBlocks.DEADLY_NIGHTSHADE_BLOCK.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BroglisPlantsBlocks.POTTED_DEADLY_NIGHTSHADE.get(), RenderType.cutout());
    }
